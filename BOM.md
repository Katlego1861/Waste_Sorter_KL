...
| **ESP32 Dev Board**                            | Main microcontroller used to control OLED , servos, and LEDs. It processes input signals and executes programmed commands . | 1        |
